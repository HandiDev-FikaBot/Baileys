# 🚀 Baileys WhatsApp API - By Tim Fika-Ai
...
```sh
npm install @fikadev/baileys
```

Atau dengan **Yarn**:

```sh
yarn add @fikadev/baileys
```
...
📩 **Email**: fikastore.cs@gmail.com  
🌍 **Website**: [Baileys API](https://github.com/HandiDev-FikaBot/Baileys)  
